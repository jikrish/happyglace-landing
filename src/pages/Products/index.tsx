  ...
  const products = [
    {
      ...
      imageSrc: `${process.env.PUBLIC_URL}/img/products/corporate-gifts.png`,
    ...
    },
    {
      ...
      imageSrc: `${process.env.PUBLIC_URL}/img/products/wedding-gifts.png`,
    ...
    },
    {
      ...
      imageSrc: `${process.env.PUBLIC_URL}/img/products/steel-bottle.png`,
    ...
    },
    {
      ...
      imageSrc: `${process.env.PUBLIC_URL}/img/products/calendar.png`,
